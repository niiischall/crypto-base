  ...
  const coinHandler = selectedCoin => {
    ...
    if (userId) {
      if (isCoinFollowed) {
        const coinObj = {
          userId,
          followingCoins: followingCoins.filter(coin => coin.slug !== coin.slug)
        };
        dispatch(Object(_store_actions_actionHome__WEBPACK_IMPORTED_MODULE_6__["followCoin"])(coinObj));
      } else {
        const coinObj = {
          userId,
          followingCoins: followingCoins.concat(coin)
        };
        dispatch(Object(_store_actions_actionHome__WEBPACK_IMPORTED_MODULE_6__["followCoin"])(coinObj));
      }
    } else {
...
//# sourceMappingURL=app.ebe6146b55d52e4cc7cd.hot-update.js.map