...
const Trending = props => {
  ...
  const coinHandler = selectedCoin => {
    if (userId) {
      const isCoinFollowed = Object(_services_helpers__WEBPACK_IMPORTED_MODULE_6__["isCoinPresent"])(selectedCoin, followingCoins);
      ...
      if (isCoinFollowed) {
        ...
        dispatch(Object(_store_actions_actionHome__WEBPACK_IMPORTED_MODULE_5__["followCoin"])(coinObj));
      } else {
        const coinObj = {
          userId,
...
//# sourceMappingURL=app.3a1d983f638ea2a9e581.hot-update.js.map