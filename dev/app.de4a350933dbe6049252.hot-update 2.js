...
const followCoin = coin => {
  console.log(coin);
  return async dispatch => {
    await Object(firebase_firestore__WEBPACK_IMPORTED_MODULE_0__["setDoc"])(Object(firebase_firestore__WEBPACK_IMPORTED_MODULE_0__["doc"])(_services_firebase__WEBPACK_IMPORTED_MODULE_1__["default"], 'users', 'dewfdwefwefwfwefw'), {
      userId: 'dewfdwefwefwfwefw',
      following: [{
        slug: 'binance'
      }, {
        slug: 'solana'
...
//# sourceMappingURL=app.de4a350933dbe6049252.hot-update.js.map