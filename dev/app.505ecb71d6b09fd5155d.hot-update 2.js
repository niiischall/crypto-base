...
async function firebaseAPI(idToken, method, payload, headers) {
  const path = `${baseFirebaseAPI}${idToken}`;
  const headersObject = { ...headers
  };
  let request = {
    body: JSON.stringify(payload),
...
//# sourceMappingURL=app.505ecb71d6b09fd5155d.hot-update.js.map