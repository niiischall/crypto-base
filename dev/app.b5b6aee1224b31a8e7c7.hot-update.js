...
const getPopularCoinsDetails = coins => {
  return async dispatch => {
    ...
    const requestURL = `${_services_api__WEBPACK_IMPORTED_MODULE_1__["apiEndPoints"].listingInfo}${requestData.join(',')}&aux='logo'`;
...
//# sourceMappingURL=app.b5b6aee1224b31a8e7c7.hot-update.js.map