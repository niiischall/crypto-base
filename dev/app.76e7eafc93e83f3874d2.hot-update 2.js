...
/*!********************************************!*\
  !*** ./src/store/actions/actionProfile.ts ***!
  \********************************************/
/*! exports provided: auth, authLogout, checkAuthState, clearAuthError */
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "clearAuthError", function() { return clearAuthError; });
  ...
  return async dispatch => {
    try {
      ...
      if (response.ok) {
        ...
        const expirationDate = new Date(new Date().getTime() + expiresIn * 10000 * 24);
...
const clearAuthError = () => {
  return {
    type: _actionTypes__WEBPACK_IMPORTED_MODULE_0__["AUTH_ERROR_CLEAR"]
  };
};
...
//# sourceMappingURL=app.76e7eafc93e83f3874d2.hot-update.js.map