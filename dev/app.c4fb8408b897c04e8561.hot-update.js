...
const Follow = props => {
  ...
  const setNotification = coinSlug => {
    const isCoinNotified = Object(_services_helpers__WEBPACK_IMPORTED_MODULE_6__["isCoinPresent"])(coinSlug, notificationCoins);

    if (isCoinNotified) {
      dispatch(Object(_store_actions_actionHome__WEBPACK_IMPORTED_MODULE_5__["stopNotifications"])(coinSlug));
    } else {
      dispatch(Object(_store_actions_actionHome__WEBPACK_IMPORTED_MODULE_5__["startNotifications"])(coinSlug));
    }
  };
...
//# sourceMappingURL=app.c4fb8408b897c04e8561.hot-update.js.map