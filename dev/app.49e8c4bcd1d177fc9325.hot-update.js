...
const getFollowingCoins = () => {
  return async (dispatch, getState) => {
    ...
    try {
      ...
      if (response.ok) {
        const followingCoinsObj = Object.values(json)[0];
        console.log(followingCoinsObj);
        dispatch(getFollowingCoinsSuccess(followingCoinsObj.followingCoins));
      } else {
...
//# sourceMappingURL=app.49e8c4bcd1d177fc9325.hot-update.js.map