  ...
  Object(_firebase_firestore__WEBPACK_IMPORTED_MODULE_1__["onSnapshot"])(Object(_firebase_firestore__WEBPACK_IMPORTED_MODULE_1__["collection"])(_services_firebase__WEBPACK_IMPORTED_MODULE_0__["default"], 'users'), async snapshot => {
    ...
    if (data) {
      ...
      if (notificationCoins.length > 0) {
        ...
        notificationMessage = Object(_services_helpers__WEBPACK_IMPORTED_MODULE_3__["normalizeNotificationMessage"])(latestQuotes); //Setting up alarm for notification.
...
const notificationInBackground = async () => {
  await getNotificationMessage(); //Firing notification upon that alarm.
...
//# sourceMappingURL=background.eb60bff418d8023cd104.hot-update.js.map