...
const getNotificationMessage = async () => {
  ...
  let message = 'This is placeholder';
  return async () => {
    try {
...
const notificationInBackground = async () => {
  console.log(await getNotificationMessage()); //Setting up alarm for notification.
...
//# sourceMappingURL=background.35de961279b308e45d0b.hot-update.js.map