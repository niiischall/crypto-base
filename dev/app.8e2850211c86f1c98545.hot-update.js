...
/*!*****************************************!*\
  !*** ./src/store/actions/actionHome.ts ***!
  \*****************************************/
/*! exports provided: getPopularCoins, getPopularCoinsDetails, followCoinSuccess, followCoinFailure, followCoin, getFollowingCoinsDetails, startNotifications, stopNotifications */
...
const followCoin = coinObj => {
  return async (dispatch, getState) => {
    try {
      const response = await Object(_services_api__WEBPACK_IMPORTED_MODULE_1__["firebaseAPI"])(getState().profile.userId, 'post', coinObj);

      if (response.ok) {
        dispatch(followCoinSuccess(coinObj.followingCoins));
      } else {
...
//# sourceMappingURL=app.8e2850211c86f1c98545.hot-update.js.map