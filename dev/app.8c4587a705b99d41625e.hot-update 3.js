...
const Popular = () => {
  ...
  const coinHandler = coin => {
    ...
    if (userId) {
      if (isCoinFollowed) {
        dispatch(Object(_store_actions_actionHome__WEBPACK_IMPORTED_MODULE_6__["unfollowCoin"])(coin));
      } else {
        dispatch(Object(_store_actions_actionHome__WEBPACK_IMPORTED_MODULE_6__["followCoin"])(coin));
      }
    } else {
      handleDialogOpen();
    }
...
//# sourceMappingURL=app.8c4587a705b99d41625e.hot-update.js.map