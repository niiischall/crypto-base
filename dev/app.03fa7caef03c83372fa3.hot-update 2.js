...
const getFollowingCoinsSuccess = followingCoinsObj => {
  return {
    type: _actionTypes__WEBPACK_IMPORTED_MODULE_0__["FETCH_FOLLOW_COINS_SUCCESS"],
    followingCoins: followingCoinsObj.followingCoins
  };
};
  ...
  return async (dispatch, getState) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        console.log(followingCoins[followingCoins.length() - 1]);
        dispatch(getFollowingCoinsSuccess(followingCoins.pop()));
      } else {
...
//# sourceMappingURL=app.03fa7caef03c83372fa3.hot-update.js.map