...
const getFollowingCoins = () => {
  return async (dispatch, getState) => {
    const queryParams = getState().profile.idToken + '&equalTo="' + getState().profile.userId + '"';
    ...
    try {
      ...
      if (response.ok) {
        ...
        dispatch(getFollowingCoinsSuccess(latestValue.followingCoins));
      } else {
...
//# sourceMappingURL=app.b62d06269fcc212f3666.hot-update.js.map