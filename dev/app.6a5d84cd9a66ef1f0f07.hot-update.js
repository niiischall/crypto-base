...
const getFollowingCoinsDetails = coins => {
  return async dispatch => {
    console.log(coins);
    const requestURL = `${_services_api__WEBPACK_IMPORTED_MODULE_1__["apiEndPoints"].coinsInfo}${coins.join(',')}`;
...
//# sourceMappingURL=app.6a5d84cd9a66ef1f0f07.hot-update.js.map