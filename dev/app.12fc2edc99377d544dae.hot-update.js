...
function home(state = initialState, action) {
  switch (action.type) {
    ...
    case _actions_actionTypes__WEBPACK_IMPORTED_MODULE_0__["FETCH_NOTIFIED_COINS_DETAILS_SUCCESS"]:
      {
        return Object.assign({}, state, {
          notificationCoinsDetails: action.coinsInfo
        });
      }

    case _actions_actionTypes__WEBPACK_IMPORTED_MODULE_0__["FETCH_NOTIFIED_COINS_DETAILS_FAILURE"]:
      {
        return Object.assign({}, state, {
          error: action.error
        });
...
//# sourceMappingURL=app.12fc2edc99377d544dae.hot-update.js.map