...
const Popular = () => {
  ...
  const coinHandler = selectedCoin => {
    const isCoinFollowed = Object(_services_helpers__WEBPACK_IMPORTED_MODULE_7__["isCoinPresent"])(selectedCoin, followingCoins);
    console.log(isCoinFollowed);

    if (userId) {
      if (isCoinFollowed) {
        const coinObj = {
          userId,
          followingCoins: followingCoins.filter(coin => coin.slug !== selectedCoin.slug)
        };
        dispatch(Object(_store_actions_actionHome__WEBPACK_IMPORTED_MODULE_6__["followCoin"])(coinObj));
      } else {
        const coinObj = {
          userId,
          followingCoins: followingCoins.concat(selectedCoin)
        };
        dispatch(Object(_store_actions_actionHome__WEBPACK_IMPORTED_MODULE_6__["followCoin"])(coinObj));
      }
    } else {
...
//# sourceMappingURL=app.2c6e4b5447d24e59fa5f.hot-update.js.map