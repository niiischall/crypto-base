...
const App = () => {
  ...
  const notificationCoins = Object(react_redux__WEBPACK_IMPORTED_MODULE_2__["useSelector"])(state => state.home.notificationCoins);
  const notificationCoinDetails = Object(react_redux__WEBPACK_IMPORTED_MODULE_2__["useSelector"])(state => state.home.notificationCoinsDetails);
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_0__["useEffect"])(() => {
    if (notificationCoins.length > 0) {
      dispatch(Object(_store_actions_actionHome__WEBPACK_IMPORTED_MODULE_6__["getNotifiedCoinsDetails"])(notificationCoins));
    }
  }, [dispatch, notificationCoins]);
  console.log('Notification coins: ');
  console.log(notificationCoins);
  console.log(notificationCoinDetails);
...
//# sourceMappingURL=app.789427d386b1484dd928.hot-update.js.map