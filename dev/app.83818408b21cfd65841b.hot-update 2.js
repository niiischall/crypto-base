...
/*!*****************************************!*\
  !*** ./src/store/actions/actionHome.ts ***!
  \*****************************************/
/*! exports provided: getPopularCoins, getPopularCoinsDetails, followCoinSuccess, followCoinFailure, followCoin, getFollowingCoins, getFollowingCoinsDetails, startNotifications, stopNotifications */
  ...
  return async (dispatch, getState) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        console.log(followingCoins.pop());
      } else {
        console.log('Error!');
      }
    } catch (error) {
...
//# sourceMappingURL=app.83818408b21cfd65841b.hot-update.js.map