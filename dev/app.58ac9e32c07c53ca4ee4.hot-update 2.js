  ...
  const coinHandler = coin => {
    if (userId) {
      ...
      if (isCoinFollowed) {
        const coinObj = {
          userID: userId,
          followingCoins: followingCoins.filter(coin => coin.slug !== coin)
        };
        dispatch(Object(_store_actions_actionHome__WEBPACK_IMPORTED_MODULE_5__["followCoin"])(coinObj, userId));
      } else {
        const coinObj = {
          userID: userId,
...
//# sourceMappingURL=app.58ac9e32c07c53ca4ee4.hot-update.js.map