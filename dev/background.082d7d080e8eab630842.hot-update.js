...
const getMarketStatus = async coins => {
  const requestURL = `${_services_api__WEBPACK_IMPORTED_MODULE_2__["apiEndPoints"].coinsInfo}${coins.join(',')}`;
...
//# sourceMappingURL=background.082d7d080e8eab630842.hot-update.js.map