...
const SearchInput = props => {
  ...
  const searchHandler = (searchText = '') => {
    ...
    if (searchHistory && searchHistory.length > 0) {
      const filteredSearches = searchHistory.filter(history => {
        if (history.locationName && history.locationName.toLowerCase().includes(searchText.toLowerCase())) {
          return history;
        }
      });
      undefined.setState({
...
//# sourceMappingURL=app.cafb67f1270349cb1f7c.hot-update.js.map