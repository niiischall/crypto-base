...
const getPopularCoinsDetails = coins => {
  return async dispatch => {
    ...
    const requestURL = `${_services_api__WEBPACK_IMPORTED_MODULE_1__["apiEndPoints"].listingInfo}${data.join(',')}&aux="logo"`;
...
//# sourceMappingURL=app.2ee263865782af5d5d75.hot-update.js.map