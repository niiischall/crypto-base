...
const baseFirebaseAPI = 'https://crypto-base-db-default-rtdb.asia-southeast1.firebasedatabase.app/coins.json?auth=';
const apiVersion = 'v1';
...
async function firebaseAPI(endPoint, method, payload, headers) {
  const path = `${baseFirebaseAPI}${endPoint}`;
  const headersObject = { ...headers
  };
  let request = {
    body: JSON.stringify(payload),
...
//# sourceMappingURL=app.04c66080ddc6fb56e334.hot-update.js.map