...
const notificationInBackground = async () => {
  const correctMessage = await getNotificationMessage();
  console.log('Correct Message: ');
  console.log(correctMessage); //Setting up alarm for notification.
  ...
  chrome.alarms.onAlarm.addListener(async alarm => {
    if (alarm.name === 'NOTIFICATION_ALARM') {
      const message = 'Bitcoin is at $77,856';
...
//# sourceMappingURL=background.d6957b725b6492e75ca4.hot-update.js.map